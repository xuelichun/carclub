...
<script type="text/javascript" src="<%=basePath %>back/js/replinotice_list.js"></script>
<title>车友会申请通知列表</title>
<script>
	// skin demo
	(function() {
	var _skin, _jQuery;
			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							通知读取类型
							<select name="fangyuanEntity.fyHxCode" id="fyHx" class="ui_select01" onchange="selectAnByRG()">
                                <option value="1">未读</option>
                                <option value="2">已读</option>
                            </select>
							申请时间
							<input type="text"  class="laydate-icon span1-1 ui_input_txt02" id="Calendar" />
							<script>
								!function(){
									laydate.skin('molv');
							...
							申请编号&nbsp;&nbsp;<input type="text" id="an_id" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
							<a href="javascript:selectRepByParam()" style="padding-left: 12px;text-align: center"><img alt="" src="<%=basePath %>back/images/myImage/search.png"></a>
						</div>
						<div id="box_bottom">
							<input type="button" value="申请通过" class="ui_input_btn01" onclick="passApli()" /> 
							<input type="button" value="申请不通过" class="ui_input_btn01" onclick="negApli();" /> 
						</div>
					</div>
				</div>
			</div>
