...
Ext.onReady(function() {
			...
			function initWebSocket() {
				if (window.WebSocket) {
					websocket = new WebSocket(encodeURI('ws://www.zeepn.com/message'));
					...
					websocket.onmessage = function(message) {
						...
						if (message.type == 'message') {
							...
							Ext.each(message.list,function(userNick){
							...
							//用户上线
								...
								var root = onlineUser.getRootNode();
								var userNick = message.userNick;
								var node = root.findChild('id',userNick);
