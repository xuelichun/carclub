...
<script type="text/javascript" src="<%=basePath %>back/js/activity_list.js"></script>
<title></title>
			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							活动类型<select name="city" id="act" class="ui_select01" onchange="selectActByType()">
    							<option value="1">慈善</option>
    							<option value="2">自驾游</option>
    						</select>
    						活动开始日期
							<input type="text"  class="laydate-icon span1-1 ui_input_txt02" id="Calendar" onchange="selectActByTime1()"  />
							活动结束日期
							<input type="text"  class="laydate-icon span1-1 ui_input_txt02" id="Calendar2" onchange="selectActByTime2()"  />
							<script>
								!function(){
									laydate.skin('molv');
							...
							活动编号&nbsp;&nbsp;<input type="text" id="act_id" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
							<a href="javascript:selectActByParam()" style="padding-left: 12px;text-align: center"><img alt="" src="<%=basePath %>back/images/myImage/search.png"></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
							...
							<input type="button" value="首页" class="ui_input_btn01" onclick="selectFirstActivity()"/>
							<input type="button" value="上一页" class="ui_input_btn01" onclick="selectLastActivity()" />
							<input type="button" value="下一页" class="ui_input_btn01"
								onclick="selectNextActivity();" />
							<input type="button" value="尾页" class="ui_input_btn01"
								onclick="selectEndActivity();" />
						...
						转到第<input type="text" id="text1" class="ui_input_txt01" />页
							 <input type="button" class="ui_input_btn01" value="跳转" onclick="selectIndexActivity();" />
					</div>
				</div>
			</div>
		</div>
