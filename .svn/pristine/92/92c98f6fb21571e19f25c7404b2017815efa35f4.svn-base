...
<script type="text/javascript" src="<%=basePath %>back/js/pre_rank.js"></script>
<title></title>
				...
				<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
							...
							<input type="button" value="首页" class="ui_input_btn01" onclick="selectFirstPIRank()" />
							<input type="button" value="上一页" class="ui_input_btn01" onclick="selectLastPIRank()" />
							<input type="button" value="下一页" class="ui_input_btn01"
								onclick="selectNextPIRank();" />
							<input type="button" value="尾页" class="ui_input_btn01"
								onclick="selectEndPIRank();" />
						<!--     如果是最后一页，则只显示首页、上一页 -->
						
						转到第<input type="text" id="text1" class="ui_input_txt01" />页
							 <input type="button" class="ui_input_btn01" value="跳转" onclick="selectIndexPIRank();" />
					</div>
				</div>
			</div>
		</div>
