...
public class WebSocketMessageInboundPool {
	...
	public static void addMessageInbound(WebSocketMessageInbound inbound){
		//添加连接
		//System.out.println("user : " + inbound.getUserNick() + " join..");
		connections.put(inbound.getUserNick(), inbound);
	}
	...
	public static void removeMessageInbound(WebSocketMessageInbound inbound){
		//移除连接
		//System.out.println("user : " + inbound.getUserNick() + " exit..");
		connections.remove(inbound.getUserNick());
	}
