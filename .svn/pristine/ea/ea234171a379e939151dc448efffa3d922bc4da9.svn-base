...
<script type="text/javascript" src="<%=basePath %>back/js/present_list.js"></script>
<title></title>
			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							车友会编号&nbsp;&nbsp;<input type="text" id="club_id" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
							车友会名&nbsp;&nbsp;<input type="text" id="club_name" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
							<a href="javascript:selectPIByParam()" style="padding-left: 12px;text-align: center"><img alt="" src="<%=basePath %>back/images/myImage/search.png"></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
							...
							<input type="button" value="首页" class="ui_input_btn01" onclick="selectFirstPresent()"/>
							<input type="button" value="上一页" class="ui_input_btn01" onclick="selectLastPresent()" />
							<input type="button" value="下一页" class="ui_input_btn01"
								onclick="selectNextPresent();" />
							<input type="button" value="尾页" class="ui_input_btn01"
								onclick="selectEndPresnt();" />
						...
						转到第<input type="text" id="text1" class="ui_input_txt01" />页
							 <input type="button" class="ui_input_btn01" value="跳转" onclick="selectIndexPresent();" />
					</div>
				</div>
			</div>
		</div>
