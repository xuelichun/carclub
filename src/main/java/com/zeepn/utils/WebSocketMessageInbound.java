...
public class WebSocketMessageInbound extends MessageInbound {
	...
	public WebSocketMessageInbound(String userNick) {
	...
	protected void onOpen(WsOutbound outbound) {
		...
		result.element("userNick", this.userNick);
		//向所有在线用户推送当前用户上线的消息
		...
		//向当前连接发送当前在线用户的列表
		WebSocketMessageInboundPool.sendMessageToUser(this.userNick, result.toString());
	}
