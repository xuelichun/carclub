...
<script type="text/javascript" src="<%=basePath %>back/js/adv_list.js"></script>
<title></title>
	...
	<form id="submitForm" name="submitForm" action="" method="post">
		...
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							广告类型<select name="city" id="advType" class="ui_select01" onchange="selectActByType()">
    							<option value="-1">请选择</option>
    						</select>
    						广告商<select name="city" id="advser" class="ui_select01" onchange="selectActByType()">
    							<option value="-1">请选择</option>
    						</select>
							广告编号&nbsp;&nbsp;<input type="text" id="adv_id" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
							<a href="javascript:selectAdvByParam()" style="padding-left: 12px;text-align: center"><img alt="" src="<%=basePath %>back/images/myImage/search.png"></a>
						</div>
					</div>
				</div>
			</div>
			<div class="ui_content">
				...
				<input type="button" value="删除" class="ui_input_btn01" onclick="selectFirstAdv()" />
				<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
							...
							<input type="button" value="首页" class="ui_input_btn01" onclick="selectFirstAdv()" />
							<input type="button" value="上一页" class="ui_input_btn01" onclick="selectLastAdv()" />
							<input type="button" value="下一页" class="ui_input_btn01"
								onclick="selectNextAdv();" />
							<input type="button" value="尾页" class="ui_input_btn01"
								onclick="selectEndAdv();" />
						<!--     如果是最后一页，则只显示首页、上一页 -->
						
						转到第<input type="text" id="text1" class="ui_input_txt01" />页
							 <input type="button" class="ui_input_btn01" value="跳转" onclick="selectIndexAdv();" />
					</div>
				</div>
			</div>
		</div>
