...
<script type="text/javascript" src="<%=basePath %>back/js/club_list.js"></script>
<title>车友会列表</title>
				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
    						...
    						<div style="float: left;">
    						城市<select name="city" id="c" class="ui_select01" onchange="selectClubByCity()">
    							<option value="-1">请选择</option>
    						</select>
    						车的品牌
    						<select name="fangyuanEntity.fyStatus"  class="ui_select01" id="cb" onchange="selectCD()">
                             	<option value="-1">请选择</option>
                              </select>
							车系
							<select name="fangyuanEntity.fyStatus"  class="ui_select01" id="cd" onchange="selectClubByCD()">
                            	<option value="-1">请选择</option>
                            </select>
