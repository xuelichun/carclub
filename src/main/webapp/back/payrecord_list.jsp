...
<script type="<%=basePath %>back/text/javascript" src="scripts/jquery/jquery-1.7.1.js"></script>
...
<script type="text/javascript" src="<%=basePath %>back/js/payrecord_list.js"></script>
<title>缴费列表</title>
			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							缴费类型
							<select name="fangyuanEntity.fyHxCode" id="fyHx" class="ui_select01" onchange="selectOpFee()">
                                <option value="1">年费</option>
                                <option value="2">功能费用</option>
                                <option value="3">人数级别费用</option>
                            </select>
							缴费日期
							<input type="text"  class="laydate-icon span1-1 ui_input_txt02" id="Calendar" onchange="selectAllPrByTime()"  />
							<script>
								!function(){
									laydate.skin('molv');
							...
							缴费编号&nbsp;&nbsp;<input type="text" id="text2" name="fangyuanEntity.fyZldz" class="ui_input_txt02"/>
							车友会编号&nbsp;&nbsp;<input type="text" id="text3" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
							<a href="javascript:selectClubByParam()" style="padding-left: 12px;text-align: center"><img alt="" src="<%=basePath %>back/images/myImage/search.png"></a>
							<div id="box_bottom">
						</div>
						</div>
					</div>
				...
				<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
							...
							<input type="button" value="首页" class="ui_input_btn01" onclick="selectFirstPr()"/>
							<input type="button" value="上一页" class="ui_input_btn01" onclick="selectLastPr()" />
							<input type="button" value="下一页" class="ui_input_btn01"
								onclick="selectNextPr();" />
							<input type="button" value="尾页" class="ui_input_btn01"
								onclick="selectEndPr();" />
						<!--     如果是最后一页，则只显示首页、上一页 -->
						转到第<input type="text" id="text1" class="ui_input_txt01" />页
							 <input type="button" class="ui_input_btn01" value="跳转" onclick="selectIndexPr();" />
					</div>
				</div>
			</div>
		</div>
